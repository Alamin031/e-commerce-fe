...
import type { Category, CategoryWithProducts, Product, PaginatedResponse } from "../types"
...
export class CategoriesService {
  ...
  static async getCategories(): Promise<Category[]> {
    const response = await apiClient.get<Category[]>(API_ENDPOINTS.CATEGORIES_GET)
    return response.data.data!
  }
